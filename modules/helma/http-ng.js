/**
 * Basic module for using HttpComponents, particularly HttpClient.
 */

importJar('http-ng/apache-mime4j-0.3.jar');
importJar('http-ng/commons-codec-1.3.jar');
importJar('http-ng/commons-io-1.2.jar');
importJar('http-ng/commons-logging-1.1.1.jar');
importJar('http-ng/httpcore-4.0-beta2.jar');
importJar('http-ng/httpcore-nio-4.0-beta2.jar');
importJar('http-ng/httpmime-4.0-alpha4.jar');
importJar('http-ng/httpclient-4.0-alpha4.jar');
